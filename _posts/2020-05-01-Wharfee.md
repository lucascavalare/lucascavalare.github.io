...
__Wharfee__ is a powerful interactive shell with autocompletion and history. Use [Wharfee](http://wharfee.com), a Python-based interactive CLI. __*Wharfee*__ is based on `docker-py` and uses a few Python modules to create interactive shell. 
